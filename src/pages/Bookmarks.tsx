            ...
            <div className="space-y-8">
              ...
              {bookmarks?.length === 0 && (
                <div className="text-center py-20 bg-white rounded-3xl border border-slate-100 border-dashed shadow-sm">
                  ...
                  <Link to="/feed" className="inline-block mt-6 px-6 py-2 bg-white border border-slate-200 text-slate-700 font-medium rounded-xl hover:bg-slate-50 transition-colors">
                    Explore Stories
                  </Link>
                </div>
              )}
